...
namespace Práctica2
{
    public partial class Form1 : Form
    {
        ...
        private void areaTrabajo_Paint(object sender, PaintEventArgs e)
        {
            ...
            g.FillRectangle(Brushes.Green,10,100,200,300);
        ...
        private void panel2_Paint(object sender, PaintEventArgs e)
        {
            ...
            s.FillRectangle(Brushes.Yellow, 0, 0, 80, 80);
            s.DrawRectangle(Pens.Red, 0, 0, 0, 80);
        }
        ...
        private void panel3_Paint(object sender, PaintEventArgs e)
        {
            ...
            f.FillEllipse(Brushes.Magenta, r);
        }
